    ...
    try {
      ...
      if (!candidateFailed) {
        if (
          ...
          if (bindingPackageVersion !== '3.1.0') {
            throw new Error(
              `WASI binding package version mismatch, expected 3.1.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
            );
          }
        }
