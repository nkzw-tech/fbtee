...
describe('Test fbt transforms without the jsx transform', () => {
  ...
  it('should preserve JSX text whitespace when preserveWhitespace=true', async () => {
    expect(
      snapshotTransformKeepJsx(
        withFbtImportStatement(`
  ...
  it(`should match JSX and not insert implicit spaces between two fbt constructs`, async () =>
    expect(
      snapshotTransformKeepJsx(
        withFbtImportStatement(`
        <fbt desc="">
