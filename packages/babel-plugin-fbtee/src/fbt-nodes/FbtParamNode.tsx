...
import { BindingName, ValidParamOptions } from '../FbtConstants.tsx';
    ...
    try {
      ...
      const gender =
        rawOptions.gender != null && typeof rawOptions.gender !== 'boolean'
          ? enforceExpression(rawOptions.gender)
          : null;
      const number =
